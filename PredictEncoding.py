...
def train_autoencoders_alex(X_train, X_valid, Y_train, Y_valid, norms_X, norms_Y):  # Dan: for untrained AE
...
def main():
    ...
    x_type = "rat_vitro"
    y_type = "human_vitro"  # Dan: change output domain here!
    ...
    all_maes = [];  # Dan: added for storing results

    for k in range(20,21):  # Dan: number of genes in set (20, 35, ...)
        for i in range(26,29):  # Dan: names of sets
            """
    ...
    """ Dan: this block can be uncommented to store the prediction values
